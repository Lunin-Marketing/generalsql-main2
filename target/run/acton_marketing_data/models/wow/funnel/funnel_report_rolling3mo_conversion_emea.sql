  ...
  create  table "acton"."dbt_actonmarketing"."funnel_report_rolling3mo_conversion_emea__dbt_tmp"
  as (
...
WITH base AS (
    ...
    FROM "acton"."dbt_actonmarketing"."funnel_report_rolling3mo_combined_emea"
    GROUP BY 1
)
