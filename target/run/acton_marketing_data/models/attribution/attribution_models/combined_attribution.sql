  ...
  create  table "acton"."dbt_actonmarketing"."combined_attribution__dbt_tmp"
  as (
...
WITH ao_combined AS (
   ...
   FROM "acton"."dbt_actonmarketing"."ao_combined" 
    ...
    SELECT *
    FROM "acton"."dbt_actonmarketing"."lead_creation"

), first_touch AS (

    SELECT *
    FROM "acton"."dbt_actonmarketing"."first_touch"
    ...
    SELECT *
    FROM "acton"."dbt_actonmarketing"."opportunity_creation"
